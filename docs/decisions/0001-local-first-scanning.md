...
VibeCheck is strictly **local-first**. It only scans the bundled demo fixture and
...
- Remote/hosted scanning is deferred to a later release with proper
  authorization, sandboxing and rate limiting.
